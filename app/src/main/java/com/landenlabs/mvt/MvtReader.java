...
public final class MvtReader {
    ...
    public static JtsMvt loadMvt(File file,
        ...
        try(final InputStream is = new FileInputStream(file)) {
            jtsMvt = loadMvt3(is, geomFactory, tagConverter, ringClassifier);
        }
     ...
     * @see RingClassifier
     */
    public static JtsMvt loadMvt2(InputStream is,
                                 GeometryFactory geomFactory,
                                 ITagConverter tagConverter) throws IOException {
        return loadMvt3(is, geomFactory, tagConverter, RING_CLASSIFIER_DEFAULT);
    }
     ...
     * @see RingClassifier
     */
    public static JtsMvt loadMvt3(InputStream is,
                                 GeometryFactory geomFactory,
                                 ITagConverter tagConverter,
                                 RingClassifier ringClassifier) throws IOException {
