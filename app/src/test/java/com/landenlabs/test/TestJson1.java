...
public class TestJson1 {
    ...
    public void test1() {
        ...
        try {
            int total;
            byte[] jsonBytes = loadLocalBytes("test3.json");
            String jsonStr = new String(jsonBytes);

            initMemory();
            JsonReader reader = new JsonReader(jsonStr, true);
        ...
        System.out.printf("Den faster than stm by %.2f%%\n", (stmDelta - denDelta) * 100f / stmDelta);
